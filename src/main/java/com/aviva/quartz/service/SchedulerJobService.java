package com.aviva.quartz.service;

import com.aviva.entity.quartz.SchedulerJobInfoEntity;
import com.aviva.job.SampleCronJob;
import com.aviva.job.SimpleJob;
import com.aviva.quartz.JobScheduleCreator;
import com.aviva.repositories.quartz.SchedulerRepository;
...
public class SchedulerJobService {
  ...
  public boolean deleteJob(SchedulerJobInfoEntity jobInfo) {
    try {
      SchedulerJobInfoEntity getJobInfo = schedulerRepository.findByJobName(jobInfo.getJobName());
  ...
  public boolean pauseJob(SchedulerJobInfoEntity jobInfo) {
    try {
      SchedulerJobInfoEntity getJobInfo = schedulerRepository.findByJobName(jobInfo.getJobName());
  ...
  public boolean resumeJob(SchedulerJobInfoEntity jobInfo) {
    try {
      SchedulerJobInfoEntity getJobInfo = schedulerRepository.findByJobName(jobInfo.getJobName());
  ...
  public boolean startJobNow(SchedulerJobInfoEntity jobInfo) {
    try {
      SchedulerJobInfoEntity getJobInfo = schedulerRepository.findByJobName(jobInfo.getJobName());
  ...
  private void scheduleNewJob(SchedulerJobInfoEntity jobInfo) {
    try {
  ...
  private void updateScheduleJob(SchedulerJobInfoEntity jobInfo) {
    Trigger newTrigger;
    if (jobInfo.getCronJob()) {
